...
public class EstudioHelper {
    ...
    public List<Estudio> gerarListaDeEstudios(){
        ...
        estudio.setPreco(25);
        estudio.setAvaliacao(2.3);
        estudio.setImg("https://lh5.googleusercontent.com/p/AF1QipND_hyK0YCx8f0XSV9xgTWPwHxT1BulATWOdiR-=w90-h90-n-k-no");
        lista.add(estudio);
